...
spark_jdbc = SparkJDBCOperator(
        ...
        spark_jars = f"/opt/airflow/dags/app/postgresql-42.5.1.jar",
        jdbc_driver = "org.postgresql.Driver",
        jdbc_conn_id = "spark_jdbc",
        jdbc_table = "demo_table", 
        metastore_table = f"/opt/airflow/dags/app/bronze/superset-csv", 
        save_mode = "overwrite",
		dag=dag_spark
		)
...
save_csv >> create_postgres_table >> spark_submit >> spark_jdbc
